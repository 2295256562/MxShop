...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey("self",null=True,blank=True, verbose_name="父类类目", related_name="sub_cat", on_delete=models.CASCADE)
...
class Goods(models.Model):
    ...
    商品
    """
    category = models.ForeignKey(GoodsCategory, null=True, blank=True, verbose_name="商品类目", help_text="商品类目", on_delete=models.CASCADE)
